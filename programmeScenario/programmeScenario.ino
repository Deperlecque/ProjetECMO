...
#define moteurPin1 9 // PWM
#define moteurPin2 10 // PWM
...
void loop() {
  ...
  engineSpeed = 50 * map(abs(erreur), 0, 1023, 0, 255); // Ajuster la vitesse
  ...
  delay(1000); // Ajuster le délai selon les besoins
}
